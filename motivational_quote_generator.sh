...
case $wittySaying in
	0) echo "Here you go...";;
	1) sleep 1; echo -e "\nOne moment please..."; sleep 1;;
	2) sleep 1; echo -e "\nDigging a little deeper..."; sleep 2;;
	3) sleep 1; echo -e "\nLet me Google one..."; sleep 3;;
esac

echo
echo ${quotes[quoteNumber]}
echo ${quotes[{0..51}]} > quotes.txt
echo
